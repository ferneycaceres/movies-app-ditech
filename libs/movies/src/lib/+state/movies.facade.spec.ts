...
import { MOVIES_FEATURE_KEY, State, initialState, reducer } from './movies.reducer';
...
describe('MoviesFacade', () => {
  ...
  describe('used in NgModule', () => {
    beforeEach(() => {
      @NgModule({
        imports: [StoreModule.forFeature(MOVIES_FEATURE_KEY, reducer), EffectsModule.forFeature([MoviesEffects])],
